...
for i = 1:numel(X)  
    ...
    elseif labelsTable{i,'SV1'}~=100
        labeledData{c+1,2} = labelsTable{i,'SV1'};
        labeledData{c+2,2} = labelsTable{i,'SV1'};
        labeledData{c+3,2} = labelsTable{i,'SV1'};
    elseif labelsTable{i,'SV2'}~=100
        labeledData{c+1,2} = labelsTable{i,'SV2'};
        labeledData{c+2,2} = labelsTable{i,'SV2'};
        labeledData{c+3,2} = labelsTable{i,'SV2'};
    elseif labelsTable{i,'SV3'}~=100
        labeledData{c+1,2} = labelsTable{i,'SV3'};
        labeledData{c+2,2} = labelsTable{i,'SV3'};
        labeledData{c+3,2} = labelsTable{i,'SV3'};
    elseif labelsTable{i,'SV4'}~=100
        labeledData{c+1,2} = labelsTable{i,'SV4'};
        labeledData{c+2,2} = labelsTable{i,'SV4'};
        labeledData{c+3,2} = labelsTable{i,'SV4'};
    else
        labeledData{c+1,2} = 100;
        labeledData{c+2,2} = 100;
        labeledData{c+3,2}= 100;
    end
    c = c+3;
end
