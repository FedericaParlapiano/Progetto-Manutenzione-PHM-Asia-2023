...
plot_data(testFeatureTable1, task1Actual', 1);
...
actual2 = table2(:,1);
plot_data(testFeatureTable2, actual2(actual2~=1), 2);
...
plot_data(testFeatureTable3,  table3(:,1), 3);
...
plot_data(testFeatureTable4,  table4(:,1), 4);
