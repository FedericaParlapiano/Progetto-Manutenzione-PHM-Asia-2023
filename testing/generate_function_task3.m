function [featureTable,outputTable] = DFD_Task3_framepolicy128_modello10_prova2_generatefunction(inputData)
...
% Auto-generated by MATLAB on 19-Feb-2024 15:10:47
...
while hasdata(outputEnsemble)
    ...
    % Read signals.
    Case_full = readMemberData(member,"Case",["TIME","P2","P3","P4","P6","P7","P1","P5"]);
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            w = factor*w;
            mask_1 = (w>=factor*35) & (w<=factor*100);
            ps = ps(mask_1);
            w = w(mask_1);
...
selectedFeatureNames = ["FRM_1/Case_sigstats/SNR","FRM_1/Case_sigstats_1/SINAD","FRM_1/Case_sigstats_1/SNR","FRM_1/Case_sigstats_2/SNR","FRM_1/Case_sigstats_3/SNR","FRM_1/Case_sigstats_5/SNR","FRM_1/Case_ps_7_spec/PeakFreq1","FRM_1/Case_ps_6_spec/PeakAmp1","FRM_1/Case_ps_6_spec/PeakFreq1","FRM_1/Case_ps_5_spec/PeakAmp1","FRM_1/Case_ps_5_spec/PeakFreq1","FRM_1/Case_ps_3_spec/PeakFreq1","FRM_1/Case_ps_2_spec/PeakAmp1","FRM_1/Case_ps_2_spec/PeakFreq1","FRM_1/Case_ps_1_spec/PeakFreq1"];
